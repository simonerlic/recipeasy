//
//  RecipeSchemaV2.swift
//  recipeasy
//
//  Schema V2 - First versioned schema
//
//  This is the first versioned schema for Recipeasy. It matches the structure
//  of the previously unversioned schema, but now with proper version tracking
//  to prevent data loss on future updates.
//
//  SwiftData will automatically migrate from the unversioned schema to this
//  versioned schema when users update the app.
//
...
extension RecipeSchemaV2.Ingredient: Hashable {
    static func == (lhs: RecipeSchemaV2.Ingredient, rhs: RecipeSchemaV2.Ingredient) -> Bool {
        lhs.id == rhs.id
    }
...
extension RecipeSchemaV2.CookingStep: Hashable {
    static func == (lhs: RecipeSchemaV2.CookingStep, rhs: RecipeSchemaV2.CookingStep) -> Bool {
        lhs.id == rhs.id
    }
